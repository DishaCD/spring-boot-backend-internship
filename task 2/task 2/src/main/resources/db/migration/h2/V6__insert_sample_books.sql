-- V6__insert_sample_books.sql (H2 compatible)
...
-- Sync the sequence so future JPA insertions do not collide with sample IDs
ALTER TABLE books ALTER COLUMN id RESTART WITH 13;
